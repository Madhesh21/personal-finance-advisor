...
import { LayoutDashboard, Receipt, PieChart, Target, Settings, MessageSquare } from 'lucide-react';
  ...
  return (
    <header className="sticky top-0 z-30 w-full bg-[#112240] border-b border-slate-700 shadow-md">
      <div className="flex items-center justify-between px-6 py-4 mx-auto max-w-7xl">
        ...
        {/* User profile / right side empty or generic icon */}
        <div className="flex items-center">
          <div className="w-9 h-9 rounded-full bg-slate-700 border-2 border-emerald-500 flex items-center justify-center text-sm font-bold text-white shadow-sm">
            UR
          </div>
        </div>
      </div>
